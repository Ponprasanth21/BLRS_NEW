...
public class BLRS_UserProfile_Entity {
	...
	public BLRS_UserProfile_Entity(String bank_code, String bank_name, String branch_code, String branch_name,
			String empid, String emp_name, String userid, String username, String inactive_time, Date acc_exp_date,
			String login_low, String login_high, Date disable_start_date, Date disable_end_date, String password,
			Date pass_exp_date, String user_status, String login_status, String virtual_flg, String work_class,
			...
			byte[] photo, String domain_id, String new_user_flg, String remarks, String country_code) {
		super();
		this.bank_code = bank_code;
		this.bank_name = bank_name;
		this.branch_code = branch_code;
	...
	public BLRS_UserProfile_Entity() {
		super();
